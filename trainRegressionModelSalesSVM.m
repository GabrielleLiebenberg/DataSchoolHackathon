...
% Hierdie is die model getrain op restaurant-1-orders data vir general
% sales prediction

% added feature: value = product_price*quantity 
% removed feature: product_name 
...
% Auto-generated by MATLAB on 08-Oct-2022 11:58:29
...
predictorNames = {'Year', 'Month', 'Day', 'Time', 'ProductPrice', 'Quantity'};
predictors = inputTable(:, predictorNames);
response = inputTable.Value;
isCategoricalPredictor = [false, false, false, true, false, false];
...
trainedModel.RequiredVariables = {'Day', 'Month', 'ProductPrice', 'Quantity', 'Time', 'Year'};
